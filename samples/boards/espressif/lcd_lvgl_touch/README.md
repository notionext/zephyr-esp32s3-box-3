...
- **Screen 1**: Shows "Welcome To NN" with a "Next" button
- **Screen 2**: Shows "Welcome Sid" 
...
```bash
cd samples/boards/esp32s3_box3_lvgl_touch
...
1. **Boot**: Device shows Screen 1 with "Hello World!" text and "Next" button
2. **Touch**: Touch the "Next" button to navigate to Screen 2
3. **Screen 2**: Shows "Welcome User" text with green background
